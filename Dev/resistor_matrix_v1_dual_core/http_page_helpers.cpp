...
void appendCommonPageHeader(String& html, const char* title) {
  ...
  html += ".mask{width:120px;font-family:monospace;}.table-scroll{width:100%;overflow-x:auto;}.control-table{min-width:1580px;}.control-table td:nth-child(3){min-width:535px;}.control-table td:nth-child(5){min-width:260px;white-space:nowrap;}";
  ...
  html += ".target{width:130px;font-family:monospace;}.inline-form{display:inline-flex;gap:4px;align-items:center;flex-wrap:nowrap;}";
  ...
  html += "<div class='brand'><span class='dot'></span><span>RP2040 Matrix</span><span class='serial'>SN ";
