...
volatile uint16_t channelMask[CHANNEL_COUNT] = {
  0, 0, 0, 0, 0, 0, 0, 0
};

volatile uint32_t applyCounter[CHANNEL_COUNT] = {
  0, 0, 0, 0, 0, 0, 0, 0
};

volatile bool shiftRegistersReady = false;
volatile bool outputsKnownSafe = false;
volatile bool fatalSafeStateActive = false;
