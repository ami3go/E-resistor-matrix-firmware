...
inline constexpr uint16_t SR_DATA_SETUP_US        = 5;
inline constexpr uint16_t SR_LATCH_SETUP_US       = 5;
inline constexpr uint16_t SR_LATCH_PULSE_US       = 20;
inline constexpr uint16_t SR_CLEAR_PULSE_US       = 50;
